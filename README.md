...
| `asset_level_update.py` | Updates asset-level metadata in a project or a catalog |
...
| `bulk_assign_catalog.py` | Updates column-level metadata in a catalog |
| `bulk_assign_project.py` | Updates column-level metadata in a project |
